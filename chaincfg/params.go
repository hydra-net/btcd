...
var BitcoinLWTestNetParams = Params{
	Name:        "testnet3",
	Net:         wire.TestNet3,
	DefaultPort: "12345",
	DNSSeeds: []DNSSeed{
...
// LightWalletParams defines the network parameters for the LightWallet Client network.
var BitcoinLWRegTestParams = Params{
	Name:        "regtest",
	Net:         wire.TestNet,
	DefaultPort: "12345",
...
var XsncoinLWParams = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "xc", // always bc for main net
...
// LightWalletParams defines the network parameters for the LightWallet Client network.
var XsncoinLWRegTestParams = Params{
	Name:        "regtest",
	Net:         wire.TestNet,
	DefaultPort: "12345",
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "bcrt", // always bc for main net

	// Address encoding magics
	PubKeyHashAddrID:        0x8c, // starts with 1
	ScriptHashAddrID:        0x13, // starts with 3
...
var LitecoinLWParams = Params{
	Name:        "mainnet",
	Net:         wire.BitcoinNet(ltcdwire.MainNet),
	DefaultPort: "12345",
...
var LitecoinLWRegTestParams = Params{
	Name:        "regtest",
	Net:         wire.BitcoinNet(ltcdwire.TestNet),
	DefaultPort: "12345",
...
var RegressionNetParams = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	// TODO: RostyslavAntonyshyn remove bc from regtest
	Bech32HRPSegwit: "bc", //rt",  always bcrt for reg test net
...
var TestNet3Params = Params{
	...
	PowLimit:                 testNet3PowLimit,
	PowLimitBits:             0x1e0ffff0,
	BIP0034Height:            75, //21111, 0000000023b3a96d3484e5abb3755c413e7d41500f8e2a5c3f0dd01299cd8ef8
	BIP0065Height:            0, // 581885, 00000000007f6655f22f98e72ed80d8b06dc761d5da09df0fa1dc4be4f861eb6
	BIP0066Height:            0, // 330776, 000000002104c8c45e99a8853285a3b592602a3ccde2b832481da85e9e4ba182
	CoinbaseMaturity:         20, // 100,
	SubsidyReductionInterval: 10000, //210000,
	TargetTimespan:           time.Hour * 24 *14, // 14 days
	TargetTimePerBlock:       time.Minute * 10,    // 10 minutes
	RetargetAdjustmentFactor: 4,                   // 25% less, 400% more
	ReduceMinDifficulty:      true,
	...
	// The miner confirmation window is defined as:
	//   target proof of work timespan / target proof of work spacing
	RuleChangeActivationThreshold: 30, //1512, // 75% of MinerConfirmationWindow
	MinerConfirmationWindow:       40, //2016,
	Deployments: [DefinedDeployments]ConsensusDeployment{
		DeploymentTestDummy: {
			BitNumber:  28,
			StartTime:  1199145601, // January 1, 2008 UTC
		...
		DeploymentSegwit: {
			BitNumber:  1,
			StartTime:  1531764000,//1462060800, // May 1, 2016 UTC
			ExpireTime: 1560284399,//1493596800, // May 1, 2017 UTC.
		},
	},
